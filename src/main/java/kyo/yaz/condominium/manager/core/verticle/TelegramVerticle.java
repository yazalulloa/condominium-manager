...
public class TelegramVerticle extends BaseVerticle {
  ...
  private Single<HttpClientResponse> sendDocument(SendMessage sendDocument) {

    final var body = new JsonObject(Json.encode(sendDocument));
    return httpService.send(HttpMethod.POST, url("sendDocument"), body);
  }
