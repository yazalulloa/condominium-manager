              ...
              .flatMap(emailConfig -> {
                ...
                return Observable.fromIterable(list)
                    ...
                    .map(pdfReceipt -> {
                      ...
                      final var month = translationProvider.getTranslation(receipt.month().name(),
                      ...
                      final var emailRequest = EmailRequest.builder()
                          ...
                          .subject(subject.formatted(month, pdfReceipt.building().name(),
                              pdfReceipt.apartment().apartmentId().number()))
                          .text(bodyText)
