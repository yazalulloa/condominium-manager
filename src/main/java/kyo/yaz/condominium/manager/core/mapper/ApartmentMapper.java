...
import kyo.yaz.condominium.manager.ui.views.apartment.ApartmentViewItem;
...
public interface ApartmentMapper {
  ...
  default ApartmentViewItem map(Apartment apartment) {
    ...
    return new ApartmentViewItem(
        ...
        optional.map(Apartment.ApartmentId::number).orElse(null), apartment.name(), apartment.idDoc(),
        apartment.emails(),
