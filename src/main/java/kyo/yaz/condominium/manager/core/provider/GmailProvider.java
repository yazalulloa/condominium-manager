...
public class GmailProvider {
  ...
  public Gmail gmail() throws IOException {
    ...
    final var googleAuthorizationCodeFlow = new GoogleAuthorizationCodeFlow.Builder(transport, jsonFactory,
    ...
    final var authorize = new AuthorizationCodeInstalledApp(googleAuthorizationCodeFlow, localServerReceiver).authorize(
        "user");
