...
public class EditReceiptView extends ScrollPanel implements BeforeEnterObserver {
  ...
  private void addContent() {
    ...
    add(receiptForm, createButtonsLayout(), new Div(commonExpensesTotal), new Div(unCommonExpensesTotal),
        new Div(commonExpensesTotalPlusReserveFund),
        new Div(unCommonExpensesTotalPlusReserveFund), reserveFundsDiv, expensesView, new Hr(), debtsView, new Hr(),
