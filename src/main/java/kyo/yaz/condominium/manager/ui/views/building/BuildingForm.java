...
public class BuildingForm extends BaseForm {
  ...
  private final ComboBox<Currency> mainCurrencyComboBox = ViewUtil.currencyComboBox(
      Labels.Building.MAIN_CURRENCY_LABEL);
  @PropertyId("debtCurrency")
  private final ComboBox<Currency> debtCurrencyComboBox = ViewUtil.currencyComboBox(
      Labels.Building.DEBT_CURRENCY_LABEL);
  ...
  private final MultiSelectComboBox<Currency> currenciesToShowAmountToPayComboBox = new MultiSelectComboBox<>(
      Labels.Building.SHOW_PAYMENT_IN_CURRENCIES, Currency.values);
  @PropertyId("fixedPay")
